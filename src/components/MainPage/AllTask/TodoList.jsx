    ...
    <div className="flex flex-col space-y-4">
      <div className="taskCard ">
        <div className="d_Flex">
          <div className="flex items-center space-x-2 text-[#FFAB2D]">
            <GoDotFill />
        ...
        <div className="w-[250px]">
          <div className="h-2 w-full rounded-lg bg-[#1E1C3A]">
            <div className="h-full w-[40%] rounded-lg bg-[#FFAB2D]"></div>
          </div>
        </div>
      ...
      <div className="taskCard ">
        ...
        <div className="w-[250px]">
          <div className="h-2 w-full rounded-lg bg-[#1E1C3A]">
            <div className="h-full w-[30%] rounded-lg bg-[#E328AF]"></div>
          </div>
        </div>
        <div className="d_Flex pt-5">
      ...
      <div className="taskCard ">
        ...
        <div className="w-[250px]">
          <div className="h-2 w-full rounded-lg bg-[#1E1C3A]">
            <div className="h-full w-[20%] rounded-lg bg-[#38E25D]"></div>
          </div>
        </div>
        <div className="d_Flex pt-5">
          {AvatarGroupsData.slice(0, 2).map((el, index) => (
            <Image
              key={index}
              src={el.image}
              width={40}
